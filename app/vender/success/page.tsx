        ...
        <div style={{ minHeight: '100vh', backgroundColor: '#F5F2E7', padding: '4rem 1rem', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <div style={{ textAlign: 'center', maxWidth: '600px', padding: '2rem 1rem' }}>
                ...
                <p style={{
                    ...
                    Nuestro equipo de curaduría revisará el estado de tus libros. En breve (máximo 24 hrs) recibirás un mensaje de WhatsApp para informarte sobre la aceptación de tus títulos y agendar la recolección sin costo.
                </p>
